...
async def get_current_user(
    ...
    try:
        ...
        # 4. Bind user_id to logging context for all subsequent logs in this request
...
async def create_session(user: User = Depends(get_current_user)):
    ...
    Depends on get_current_user: get extracted user object from token
    Args:
    ...
    try:
        ...
        # 3. create access token for the session
