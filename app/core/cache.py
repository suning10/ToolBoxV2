...
class InMemoryCacheService:
    ...
    async def initialize(self) -> None:
        """Initialize in-memory cache."""
        logger.info(f"Initializing in-memory cache with default TTL: {self.default_ttl}")
...
class ValkeyCacheService:
    ...
    async def get(self, key: str) -> Optional[str]:
        ...
        Manually checking expire time is not required for redis
...
def cache_key(prefix: str, *parts: str) -> str:
    ...
    Args:
        ...
        *parts: Any number of parts to include in the key.
